...
export default function Initial() {
  ...
  return (
    <div className="w-full h-screen md:h-full bg-black flex justify-center items-center p-5 md:p-0">
      {/* Container principal */}
      <div className="w-full h-[430px] md:w-[800px] md:h-[380px] bg-[#191A1C] rounded-[10px] flex flex-col justify-between md:justify-center items-center mb-[80px] md:mb-0 ">
        ...
        <div className="w-full md:w-[700px] h-[180px] flex flex-col justify-center items-center p-5 md:p-0">
        ...
        <div className="w-full md:w-[700px] h-[60px] flex flex-row items-center justify-between px-5 md:px-0 mb-8 md:mb-0">
